...
public record UserResponseDTO(UUID id, String name, String email, String phone, UserRole role, LocalDate birthDate, UserGender gender, LocalDateTime createdAt, String avatarUrl) {
